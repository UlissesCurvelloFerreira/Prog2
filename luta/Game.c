...
Parâmetros:
- game: Ponteiro para a estrutura do jogo, contendo informações dos jogadores.
- queue: Fila de eventos do Allegro para manipulação de eventos.
- timer: Temporizador do Allegro para controlar o tempo de jogo.
