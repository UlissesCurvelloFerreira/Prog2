...
joystick* joystick_create(){														//Implementação da função "joystick_create"
	...
	element->down = 0;
	element->soco = 0;																//Insere o estado de desligado para o botão de movimentação para baixo
	element->fire = 0;
	element->chute = 0;	
	element->soco_baixo = 0;
	element->defesa = 0;															//Insere o estado de desligado para o botão de disparo (!)
...
void joystick_soco(joystick *element){ element->soco = element->soco ^ 1;}

void joystick_soco_baixo(joystick *element){ element->soco_baixo = element->soco_baixo ^ 1;}

void joystick_chute(joystick *element){ element->chute = element->chute ^ 1;}
...
void joystick_defesa(joystick *element){ element->defesa = element->defesa ^ 1;}